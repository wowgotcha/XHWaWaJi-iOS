...
//    XHDebugLog(@"******web socket失败信息： %@", error);
    MKLog([NSString stringWithFormat:@"web socket失败信息： %@", error], nil);
...
//    XHDebugLog(@":( Websocket Receive With message %@", message);
